...
describe("publisherFrontendProfileValidator", () => {
  it("[C-CLI-004] publisher component 요청을 page/homePage/index.tsx 규칙으로 통과시킨다", () => {
    // Arrange
    const request = {
      profileId: "publisher/personal/v1",
      command: "component",
      name: "HomePage",
      path: "page/homePage",
  ...
  it("[C-CLI-004][C-CLI-006] publisher 요청에 useEffect가 섞이면 생성 자체를 거부한다", () => {
    // Arrange
    const request = {
      profileId: "publisher/personal/v1",
      command: "component",
