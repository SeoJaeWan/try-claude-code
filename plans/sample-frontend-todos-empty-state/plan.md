...
# sample-frontend-todos-empty-state 실행 계획 (Sequential)
...
- 구현 결과는 `frontend-developer`가 단독으로 처리할 수 있는 frontend UI 범위로 제한한다.
...
- 산출물 위치: `plans/sample-frontend-todos-empty-state/e2e/manifest.md`, `plans/sample-frontend-todos-empty-state/e2e/todos-empty-state.spec.ts`
...
- 신규:
  ...
  - `plans/sample-frontend-todos-empty-state/plan.md`
  - `plans/sample-frontend-todos-empty-state/e2e/manifest.md`
  - `plans/sample-frontend-todos-empty-state/e2e/todos-empty-state.spec.ts`
- 삭제:
  - 없음
