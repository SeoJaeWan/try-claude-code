...
Set the active remote contract with `tcf mode set --mode personal --version v1`, inspect the stored selection with `tcf mode show`, and use `tcf --help` even before mode setup for bootstrap guidance.
