...
Use this when `plan-tdd` handles logic boundaries.
...
- Follow `references/contracts.md` First-Time Test Contract Fields and `references/workflow.md` `TDD contract mode` when unit setup or placement is missing
