    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-1 flex-col gap-1">
          <p className="text-sm font-semibold leading-none text-zinc-900 dark:text-zinc-50" data-testid={testId ? `${testId}-author` : undefined}>
            {authorName}
          </p>
      ...
      {/* Review body */}
      <p className="text-sm leading-relaxed text-zinc-700 dark:text-zinc-300" data-testid={testId ? `${testId}-body` : undefined}>
        {body}
      </p>

      {/* Footer: created date */}
      <p className="text-xs text-zinc-400 dark:text-zinc-500" data-testid={testId ? `${testId}-date` : undefined}>
        {createdAt}
      </p>
    </div>
  );
