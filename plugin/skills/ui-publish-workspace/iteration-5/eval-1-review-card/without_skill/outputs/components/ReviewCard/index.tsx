...
function StarRating({ rating }: { rating: number }) {
  return (
    <div className="flex items-center gap-0.5" aria-label={`${rating}점`} role="img">
...
export default function ReviewCard({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-3">
        <div className="relative h-10 w-10 shrink-0 overflow-hidden rounded-full bg-zinc-100 dark:bg-zinc-800">
          {avatarUrl ? (
            ...
            <span className="flex h-full w-full items-center justify-center text-sm font-semibold text-zinc-400 dark:text-zinc-500">
        ...
        <div className="flex flex-1 flex-col gap-1">
          <p className="text-sm font-semibold leading-none text-zinc-900 dark:text-zinc-50" data-testid="review-author">
            {authorName}
          </p>
      ...
      {/* Review body */}
      <p className="text-sm leading-relaxed text-zinc-600 dark:text-zinc-400" data-testid="review-body">
        {body}
      </p>
    </div>
  );
