...
import usePostLogin from "@/hooks/apis/auth/mutations/usePostLogin";
...
export default function LoginPage() {
  ...
  const { generalError, handleSubmit } = usePostLogin();
  ...
  return (
    <div className="mx-auto mt-20 max-w-md">
      ...
      <form onSubmit={(e) => { e.preventDefault(); handleSubmit(email, password, validate); }} className="space-y-4">
        <div>
