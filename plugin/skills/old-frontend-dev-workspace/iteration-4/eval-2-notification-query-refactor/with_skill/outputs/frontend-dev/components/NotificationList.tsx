...
import useNotificationFilter from "@/hooks/utils/dashboard/useNotificationFilter";

export default function NotificationList() {
  const { data, isLoading, error } = useGetNotifications();
  const { filter, filtered, handleFilterAll, handleFilterUnread } =
    useNotificationFilter(data);
