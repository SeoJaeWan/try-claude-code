    ...
    <div className="mx-auto max-w-2xl">
      ...
      {!editing ? (
        ...
        <div className="mt-6 space-y-4" data-testid="profile-form">
          ...
          <DatePicker label="생년월일" value={draft.birthDate} onChange={handleChangeBirthDate} testId="profile-birthdate" />
          ...
          <div>
            ...
            <FileUpload value={draft.avatarFileName} onChange={handleChangeAvatarFileName} />
          </div>
