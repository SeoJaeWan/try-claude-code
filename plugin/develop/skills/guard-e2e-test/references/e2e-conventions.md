...
Test authoring rules for guard-e2e-test. Shares the same Playwright-based rules as plan-tdd,
...
- Place under `guard/` subdirectory to clearly separate from bounded-surface E2E owned by plan-tdd
...
- **Single-screen tests** — per-screen/feature tests belong to plan-tdd
