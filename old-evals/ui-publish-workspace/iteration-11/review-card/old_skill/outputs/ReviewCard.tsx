      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p
            ...
            data-testid="review-card-username"
          >
            {username}
          </p>

          {/* Star rating */}
          <div className="mt-0.5 flex items-center gap-0.5" data-testid="review-card-rating">
            ...
            <span className="ml-1 text-xs text-zinc-500 dark:text-zinc-400">{rating}/5</span>
          </div>
        </div>
      </div>
