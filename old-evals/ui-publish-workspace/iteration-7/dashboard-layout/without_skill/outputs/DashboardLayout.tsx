    ...
    <div className="flex min-h-screen bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        >
          ...
          {/* Page title */}
          <h1 className="text-lg font-semibold text-zinc-900 dark:text-zinc-50" data-testid="page-title">
            {pageTitle}
          </h1>
          ...
          <div className="ml-auto flex items-center gap-2">
            {/* Notification bell */}
            <button
              className="relative rounded-md p-1.5 text-zinc-500 hover:bg-zinc-100 dark:hover:bg-zinc-800"
              aria-label="알림"
            ...
            {/* User avatar */}
            <button
              className="flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-sm font-semibold text-blue-600 dark:bg-blue-950 dark:text-blue-400"
              aria-label="사용자 메뉴"
