...
2. Consult the project dev-wiki — follow `claude-plugin/develop/references/dev-wiki-lookup.md` to narrow candidate files and pick up recorded conventions (skip silently if no wiki)
